...
<html>
	...
	<body>
		...
		<div>
			<p id="torna">
				<a href="<?php echo $torna;?>" title="Il giardiniere a Udine - Friuli: torna alla pagina iniziale">Torna indietro</a>
			</p>
		</div>
		<?php 
		...
		<div>
			<p id="img">
				<a title="Il giardiniere a Udine - Friuli: vai alla prossima immagine" href=<?php if(($img+1)<=$numero_immagini) echo $next;?>><img src="<?php echo $percorso_img;?>" alt="Giardiniere Giulio Modotti a Udine - Friuli: lavori di manutenzione verde in un giardino privato" /></a>
			</p>
		</div>

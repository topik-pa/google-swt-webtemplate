					...
					<div id="form_prenotazione">
						...
						<form class="form" id="formPrenotazione" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
							<fieldset>
								...
								<div>
									<p><strong><label for="note_prenotazione">Altre note:</label></strong><br/>
									<textarea  id="note_prenotazione" name="note_prenotazione" rows="5" cols="30">Inserisci qui eventuali altre note</textarea></p>
								</div>
